...
class RegisterBookService extends AbstractServiceProvider implements BootablePluginProviderInterface {
    ...
    public function registerPostType() {
        $args = [
            ...
            'rewrite'      => ['slug' => 'books'],
            'show_in_rest' => true,
            'taxonomies'   => [$this->publisherTaxonomy, $this->authorTaxonomy],
        ];
    ...
    private function registerAuthorTaxonomy() {
        register_taxonomy($this->authorTaxonomy, $this->postType, [
    ...
    private function registerPublisherTaxonomy() {
        register_taxonomy($this->publisherTaxonomy, $this->postType, [
